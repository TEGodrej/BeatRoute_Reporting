...
//        driverUtility.threadWait(15);
	...
	@Test(dependsOnMethods = "attendanceReport_CPB")
	public void upload_CPB_AdherenceReport() {
    	...
    	String localFolder = workspacePath + File.separator + "AttendanceReport_CPB";
    	...
    	File[] UserListFiles = folder.listFiles((dir, name) -> name.startsWith("Attendance") && name.endsWith(".csv"));
    	...
    	String newFileName = "Attendance_Report_CPB_" + today + ".csv";
    	...
    	System.out.println(" Ready to upload: " + renamedFile.getName());
    	 ...
    	 // Latest file path
           ...
           String remoteFilePath = "/Powerbi_Analytics/Beatroute/CPB/Attendance Report";
