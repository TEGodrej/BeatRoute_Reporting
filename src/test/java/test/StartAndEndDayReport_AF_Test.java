...
//        String paswrd = "Ganpati@123456";
        ...
        System.out.println("=========StartAndEndDayReport_AF===========");
	...
	public void upload_start_N_EndDayLogReport() {
    	...
    	String localFolder = workspacePath + File.separator + "UserLogReport_AF";
    	...
    	String newFileName = "AF_Start_End_Day_Activities_Report" + today + ".csv";
    	...
    	System.out.println(" Ready to upload: " + renamedFile.getName());
    	 ...
    	 // Latest file path
           ...
           String remoteFilePath = "/Powerbi_Analytics/Beatroute/Animal Feed/Start End Day Activity";
