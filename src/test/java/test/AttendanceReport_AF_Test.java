...
public class AttendanceReport_AF_Test extends BaseClassAF_Attendance{
	...
	public void upload_AF_AdherenceReport() {
    	...
    	String localFolder = workspacePath + File.separator + "AttendanceReport_AF";
    	...
    	String newFileName = "Attendance_Report_AF_" + today + ".csv";
    	...
    	System.out.println(" Ready to upload: " + renamedFile.getName());
    	 ...
    	 // Latest file path
           ...
           String remoteFilePath = "/Powerbi_Analytics/Beatroute/Animal Feed/Attendance Report";
